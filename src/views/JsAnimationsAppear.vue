...
function handleEnter(el, done) {
  gsap
    .timeline({ defaults: { ease: "sine" }, onComplete: done })
    .fromTo(el.querySelector(".bg-hover"), { y: 50, opacity: 0 }, { y: 0, opacity: 1, duration: 0.9 })
    .fromTo(el.querySelector("h2"), { x: -120, opacity: 0 }, { x: 0, opacity: 1, duration: 0.6 }, "<+=0.2")
    .fromTo(el.querySelector("p"), { x: 120, opacity: 0 }, { x: 0, opacity: 1, duration: 0.6 }, "<+=0.1");
}
...
function handleLeave(el, done) {
  gsap
    ...
    .to(el.querySelector(".bg-hover"), { y: -50, opacity: 0, duration: 0.9 })
    .to(el.querySelector("p"), { x: -120, opacity: 0, duration: 0.6 }, "<")
    .to(el.querySelector("h2"), { x: 120, opacity: 0, duration: 0.6 }, "<+=0.1");
}
</script>
